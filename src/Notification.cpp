// Taken from the Inkay plugin by Pretendo Network. Original code credit goes to
// Pretendo.
...
void StartNotificationThread(const char *value) {
  ...
  if (titleID == 0x0005001010040000L || titleID == 0x0005001010040100L ||
